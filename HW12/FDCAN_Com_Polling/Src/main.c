...
#define RX_ID          (0x222)   /* RX CAN message identifier    */
/* USER CODE END PD */
...
// changed random hex to custom 16-byte text array
static const uint8_t txData[] = {'H', 'e', 'l', 'l', 'o', ' ', 'R', 'o',
                                 'd', 'r', 'i', 'g', 'o', '!', '\r', '\n'
                                };
...
int main(void)
{
  ...
  while (1)
  {
    ...
    // recieved message print to USB cable
    printf("Message Received! ID: 0x%lX\r\n", rxHeader.Identifier);
    printf("Payload: %16.16s\r\n", rxData);
...
void BSP_PB_Callback(Button_TypeDef Button)
{
  if (Button == BUTTON_USER)
  {
    ...
    // transmit print message to USB cable
    printf("Adam's Board: Message Sent to CAN Bus!\r\n");
